...
\begin{document}
    ...
    % ----- Table of contents -----
    \include{parts/table_of_contents}
    ...
    % ----- Introduction -----
    \input{parts/sections/introduction}

    \input{parts/sections/linux_overview.tex}

    \input{parts/sections/rtos_overview.tex}

    \input{parts/sections/comparing_linux_rtos.tex}
